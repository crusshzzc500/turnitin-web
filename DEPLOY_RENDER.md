...
- Tùy chọn quét web mặc định tắt; chỉ gửi đoạn trích sang Tavily, Exa hoặc Brave khi khách chủ động bật.
...
hoặc `BRAVE_SEARCH_API_KEY` trong phần Environment của Render. Không đưa API key vào Git hoặc ZIP.
